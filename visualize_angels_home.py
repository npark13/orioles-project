...
# --- Load data ---
files = sorted(glob.glob("/Users/kevinhe/orioles-project/data/out/team_home_field_by_year/first_inning_nb_results_home_*.csv"))
...
plt.title("First-Inning Home Field Advantage (as Home Team) (2018–2024)\nAngels vs. League", fontsize=16, weight='bold')
plt.xlabel("Year")
plt.ylabel("Home Advantage (Predicted Runs Difference)")
plt.legend()
plt.grid(True, alpha=0.3)
plt.tight_layout()
plt.savefig("/Users/kevinhe/orioles-project/data/out/angels_vs_league_trends_home.png", dpi=300)
plt.show()
...
plt.title("Average First-Inning Home Field Advantage (as Home Team) (2018–2024)", fontsize=16, weight='bold')
plt.ylabel("Average Home Advantage")
plt.xticks(rotation=90)
plt.legend()
plt.grid(axis='y', alpha=0.3)
plt.tight_layout()
plt.savefig("/Users/kevinhe/orioles-project/data/out/angels_vs_league_average_home.png", dpi=300)
plt.show()